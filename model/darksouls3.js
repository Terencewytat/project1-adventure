...
scenes.createScene("Attack",
                            "\n ------------------------------------------------------------" +
                            "\n Enemy: " + enemy.enemyType + " holding a dagger!" + "\n Vigor: " + enemy.vigor +  " | ATK: " + enemy.strength + " | DEF: " + enemy.vitality +
                            "\n ------------------------------------------------------------" +
                            "\n Player: " + player.classType + " clad in worn armor!" + "\n Vigor: " + player.vigor + " | ATK: " + player.strength + " | DEF: " + player.vitality +
                            "\n ------------------------------------------------------------",
[ 
    { description: "Attack!", scene: "Attack" },
    { description: "Block!", scene: "Block" },
    { description: "Heal!", scene: "Heal" },
])

scenes.createScene("Block","\n",
[ 
    { description: "Go into Firelink Shrine", scene: "Firelink_Shrine" },
])